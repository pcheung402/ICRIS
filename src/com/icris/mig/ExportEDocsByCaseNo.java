...
public class ExportEDocsByCaseNo {
...
//    static private Writer eDocsNotFoundLog = null, eDocsRecords=null, eDocsInvalid=null;
    static private Writer eDocsRecords=null;
	...
	public static void main(String[] args) {
	    ...
	    try {
	        ...
	        String orderClause = "r.CaseNumber ASC";
...
//		String sqlWhereClause = "r.CaseNumber IN  ("				
//				+"'127773177',"
//				+"'129959270',"
//				+"'130142896',"
//				+"'130142897',"
...
//		+ ")";
		...
		String sqlWhereClause = "r.CaseNumber IN  ('133041246')";
...
//    	InputStream is = null;
	...
	private static void saveEDoc(ContentTransfer ct, RepositoryRow row) {	
...
//    	String formType = sZipEntry.substring(0, sZipEntry.lastIndexOf(".vxf")).substring(4);
    	String fileName = ct.get_RetrievalName()+"_" + sSubmissionDate;
////    	System.out.println("fileName  : " + fileName);
    	String eDocFolderFullPath = outputBaseDir + File.separator + "eDocs";
...
//    	}
    	...
    	fileName = fileName + "_" +String.valueOf(i);
    	i++;
    	fileName = fileName +".zip";
    	System.out.println("file name : " + fileName);
    	try{
    	Files.copy(is , Paths.get(eDocFolderFullPath + File.separator + fileName), StandardCopyOption.REPLACE_EXISTING);
    	eDocsRecords.append(fileName + "," + caseNumber + "," + sSubmissionDate +"\n");
    	eDocsRecords.flush();
    	} catch (Exception e){
    		e.printStackTrace();
    	}		
